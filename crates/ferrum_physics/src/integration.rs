...
impl Physics {
    pub fn integrate_linear(&mut self, dt: Float) {
        ...
        for body_id in 0..self.rigidbodies.len() {
            if self.rigidbodies.inv_mass[body_id] == 0.0 {continue;}
